...
- [ ] **Phase 36: Difficulty Schema + Discrete Curriculum** - DifficultyLevelConfig leaf model + additive CurriculumScheduler level progression (non-GPU, lowest risk, unblocks 37)
...
**Plans**: 3 plans
- [ ] 36-01-PLAN.md — DifficultyLevelConfig Pydantic v2 leaf model + range validators (TDD, Wave 1)
- [ ] 36-02-PLAN.md — difficulty_wiring module (ABSTRACT_TO_CONCRETE + DiscreteCurriculumConfig + compose_difficulty_overrides) + truth-table test (TDD, Wave 2)
- [ ] 36-03-PLAN.md — additive CurriculumScheduler progression_mode + set/advance_level + advance_stage parity (TDD, Wave 3)
...
|-------|----------------|--------|-----------|
| 36. Difficulty Schema + Discrete Curriculum | 0/3 | Planning complete | - |
| 37. Scene-Level difficulty_blocks + Env Wiring | 0/TBD | Not started | - |
